...
import { BookOpen, FileText, Upload, Send, Bot, User, HelpCircle, Brain, Play, PlusCircle } from "lucide-react";
...
import AIStudySessions from '@/components/AIStudySessions';
...
const LearningSession = () => {
  ...
  const subjectMap = {
    ...
    'practice': {
      ...
      description: 'Upload documents to summarize or create custom courses with AI-generated content'
    },
    'review': {
  ...
  const isPracticePage = subject === 'practice';
