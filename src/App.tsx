          ...
          <AuthProvider>
            <TeacherAuthProvider>
              <Routes>
                ...
                <Route path="/courses/view/:courseId" element={<ProtectedRoute><CourseViewerWrapper /></ProtectedRoute>} />
                <Route path="/courses/enroll/:courseId" element={<ProtectedRoute><CourseViewerWrapper /></ProtectedRoute>} />
